...
Google expanded Managed Agents in the Gemini API with background tasks, remote MCP support, and other capabilities aimed at building reliable, production-ready agents.
